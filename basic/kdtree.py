...
def show_nearest(k, heading, kd, p):
    ...
    print "Nearest neighbor:{0}".format(n.nearest)
    print "Distance:{0}".format(sqrt(n.dist_sqd))
    print "Nodes visited:{0}".format(n.nodes_visited)
...
if __name__ == "__main__":
    ...
    show_nearest(2, text("k-d tree with ", N, " random 3D points (generation time: ", t1-t0, "s)"), kd2, random_point(3))
